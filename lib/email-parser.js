...
const BANCOS = {
  bancolombia: {
    // El primer elemento es un catch-all de dominio: la búsqueda Gmail "from:bancolombia.com.co"
    // matchea cualquier remitente del dominio principal. Los siguientes son direcciones reales
    // conocidas (incluido el subdominio notificaciones.bancolombia.com.co usado por Bancolombia).
    // detectarBanco() usa fromLower.includes(r) → un substring del dominio también funciona como
    // fallback si la query de Gmail trae algo por otro motivo.
    remitentes: [
      'bancolombia.com.co',
